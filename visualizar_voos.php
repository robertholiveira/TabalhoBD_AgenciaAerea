...
$query = "SELECT a.nmcid_aerop as Origem, b.nmcid_aerop as Destino, v.dtsaida as Data, v.hrsaida as Hora , com.nmcia as companhia FROM t_aeroporto a, t_rota r, t_aeroporto b, t_voo v, t_aeronave ae, t_companhia com  where a.cdaerop=r.cdaerop_ori and b.cdaerop =r.cdaerop_des and v.cdaeron = ae.cdaeron and ae.cdcia = com.cdcia and r.nrrota_voo = v.nrvoo;";
                  ...
                  <div class="content-box">
                     <div class="element-wrapper">
                        ...
                        <div class="element-box">
                            <h6 class="element-header">Visualizar voos</h6>
                           <div class="form-desc"> Abaixo uma tabela com os voos:</div>
